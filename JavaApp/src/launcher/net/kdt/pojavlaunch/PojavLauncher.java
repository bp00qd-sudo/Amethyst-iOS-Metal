...
public class PojavLauncher {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        try {
            ...
            // Do not reference com.apple.eawt at compile time.  That package
            // exists only in Apple's legacy JRE and is absent from Temurin/
            // OpenJDK 8 used by the hosted Actions runners.  Reflection keeps
            // the legacy workaround available when the class is present while
            // allowing the launcher sources to compile everywhere.
